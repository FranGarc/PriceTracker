Feature: Product and Price Input
  ...
  Scenario Outline: Full input of a new item with the name
    ...
    When I enter a new Product called "<productName>" with Amount "<amount>" and Unit Type "<unitFormat>"
    ...
    Examples:
      ...
      | Huevos L                | 12     | Unidades   | 2.40  | Fruteria Las nenas |
      | Carne picada de ternera | 400    | g          | 3.54  | Carniceria Puri    |
      | Harina de Reposteria    | 1      | Kg         | 1.10  | Carreflus          |